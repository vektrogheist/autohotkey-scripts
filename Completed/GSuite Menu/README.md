...
```
          ...
          |     *create doc*      |                               |
          |_______________________| 1  *GDrive Folder Primary*    |
...
```
          ...
          |    *Add Folder*       |                                        |
          |__\___\__\___\___\__\__| Please enter Folder ID                 |
          |                       |                                        |
          |     *Remove Folder*   |                                        |
...
```
     ...
     EX: If when opening the folder in Gdrive you see https://drive.google.com/drive/u/0/folders/1fQNKva9isMAquZffglkHJSCUT-xPnQPN

     id to enter = 1fQNKva9isMAquZffglkHJSCUT-xPnQPN
